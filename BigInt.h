...
public:
    ...
    // Overloading '=' operator if the user inputs long long into BigInt class
    void operator=(long long v);      

    // Overloading '=' operator if the user inputs string into BigInt class
